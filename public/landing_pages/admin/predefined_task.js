console.log("JavaScript Loaded!"); // Check if script is running
  ...
  function checkSaveButtonState() {
    ...
    const noChangesMade = JSON.stringify(subtaskListItems) === JSON.stringify(initialSubtasks);
...
addSubtaskBtn.addEventListener("click", () => {
  ...
  if (existingSubtasks.includes(subtaskName)) {
    document.getElementById("duplicate-subtask-message").textContent = `"${subtaskName}" is already in the list.`;
...
taskList.addEventListener("click", async (e) => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("open-add-task-modal").addEventListener("click", function () {
